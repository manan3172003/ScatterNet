"""
Django settings for dodgerblue project.
...
NODEHOSTNAME = os.environ.get('HOSTNAME', default="http://localhost:8000")
...
WSGI_APPLICATION = 'dodgerblue.wsgi.application'
